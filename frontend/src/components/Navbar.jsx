        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 ">
            <div className="felx flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
              <p onClick={(e)=>navigate('/profile')} className="cursor-pointer hover:text-black">My profile</p>
              <p onClick={(e)=>navigate('/orders')} className="cursor-pointer hover:text-black">Orders</p>
